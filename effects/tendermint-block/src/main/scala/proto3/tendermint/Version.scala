...
object Version extends scalapb.GeneratedMessageCompanion[proto3.tendermint.Version] {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[proto3.tendermint.Version] =
  ...
  implicit class VersionLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, proto3.tendermint.Version])
      extends _root_.scalapb.lenses.ObjectLens[UpperPB, proto3.tendermint.Version](_l) {
