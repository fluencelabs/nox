...
object TendermintProto extends _root_.scalapb.GeneratedFileObject {
  ...
  XZpZGVuY2VIYXNoEikKEHByb3Bvc2VyX2FkZHJlc3MYECABKAxSD3Byb3Bvc2VyQWRkcmVzcyIxCgdWZXJzaW9uEhQKBWJsb2NrG
  AEgASgEUgVibG9jaxIQCgNhcHAYAiABKARSA2FwcGIGcHJvdG8z"""
        )
        .mkString
    )
