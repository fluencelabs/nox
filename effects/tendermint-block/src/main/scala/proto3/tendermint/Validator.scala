...
object Validator extends scalapb.GeneratedMessageCompanion[proto3.tendermint.Validator] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): proto3.tendermint.Validator = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[proto3.tendermint.Validator] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TendermintProto.javaDescriptor.getMessageTypes.get(8)
  ...
  implicit class ValidatorLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, proto3.tendermint.Validator]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, proto3.tendermint.Validator](_l) {
