    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): proto3.tendermint.BlockID = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __parts = Option(_root_.scalapb.LiteParser.readMessage(_input__, __parts.getOrElse(proto3.tendermint.PartSetHeader.defaultInstance)))
...
object BlockID extends scalapb.GeneratedMessageCompanion[proto3.tendermint.BlockID] {
  ...
  implicit class BlockIDLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, proto3.tendermint.BlockID]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, proto3.tendermint.BlockID](_l) {
    ...
    def parts: _root_.scalapb.lenses.Lens[UpperPB, proto3.tendermint.PartSetHeader] = field(_.getParts)((c_, f_) => c_.copy(parts = Option(f_)))
    def optionalParts: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[proto3.tendermint.PartSetHeader]] = field(_.parts)((c_, f_) => c_.copy(parts = f_))
  }
