...
export async function app(): Promise<void> {
    ...
    let contract = new web3js.eth.Contract(abi, "0x9995882876ae612bfd829498ccd73dd962ec950a");
    let enqueuedCodes = await contract.methods.getEnqueuedCodes().call({from: accounts[0]})

    console.log("contract === " + JSON.stringify(enqueuedCodes));
}
