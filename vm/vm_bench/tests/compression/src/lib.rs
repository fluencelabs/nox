...
/// This test recursively compresses sequence of SEQUENCE_SIZE bytes randomly generated by
/// IsaacRng. There are ITERATIONS_COUNT iterations of compressions. On each iteration a new
...
/// and snappy) that are choosed by "deflate_compression" feature.
#[no_mangle]
