...
class Get[F[_]: Effect] private ()(implicit sch: Scheduler) extends slogging.LazyLogging {
...
object Get {
  ...
  def apply[F[_]: Effect](
    ...
    version: Long,
    getCallbacks: BTreeRpc.SearchCallback[F]
  )(implicit sch: Scheduler): F[Option[Array[Byte]]] = new Get().get(pipe, datasetId, version, getCallbacks)
}
