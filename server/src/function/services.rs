...
impl FunctionRouter {
    ...
    pub(super) fn pass_to_local_service(&mut self, mut call: FunctionCall, ttl: usize) {
        if BuiltinService::is_builtin(&call.module) {
            match BuiltinService::from(&call.module, call.arguments.clone()) {
        ...
        let err_msg = format!("unroutable message: module {} not found", call.module());
