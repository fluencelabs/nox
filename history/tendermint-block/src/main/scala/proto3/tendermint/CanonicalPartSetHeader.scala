...
@SerialVersionUID(0L)
final case class CanonicalPartSetHeader(
  hash: _root_.com.google.protobuf.ByteString = _root_.com.google.protobuf.ByteString.EMPTY,
  total: _root_.scala.Int = 0
) extends scalapb.GeneratedMessage with scalapb.Message[CanonicalPartSetHeader]
    with scalapb.lenses.Updatable[CanonicalPartSetHeader] {
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): proto3.tendermint.CanonicalPartSetHeader = {
  ...
  def withHash(__v: _root_.com.google.protobuf.ByteString): CanonicalPartSetHeader = copy(hash = __v)
  def withTotal(__v: _root_.scala.Int): CanonicalPartSetHeader = copy(total = __v)
  ...
  def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
    ...
    (__field.number: @ _root_.scala.unchecked) match {
      ...
      case 2 => _root_.scalapb.descriptors.PInt(total)
    }
  }
  def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
  def companion = proto3.tendermint.CanonicalPartSetHeader
}

object CanonicalPartSetHeader extends scalapb.GeneratedMessageCompanion[proto3.tendermint.CanonicalPartSetHeader] {
  ...
  lazy val defaultInstance = proto3.tendermint.CanonicalPartSetHeader(
    )
  implicit class CanonicalPartSetHeaderLens[UpperPB](
    _l: _root_.scalapb.lenses.Lens[UpperPB, proto3.tendermint.CanonicalPartSetHeader]
  ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, proto3.tendermint.CanonicalPartSetHeader](_l) {
