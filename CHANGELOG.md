...
## [0.14.0](https://github.com/fluencelabs/nox/compare/rust-peer-v0.13.2...rust-peer-v0.14.0) (2023-07-20)


### ⚠ BREAKING CHANGES

* **avm:** update to avm 0.39.1 ([#1627](https://github.com/fluencelabs/nox/issues/1627))
* **dist:** make blueprint an IPLD, use CID as module ids [fixes NET-412 NET-432] ([#1595](https://github.com/fluencelabs/nox/issues/1595))
* **config:** Introduce tracing config, change allowed_binaries list format ([#1608](https://github.com/fluencelabs/nox/issues/1608))
* **logs:** print only first address of a Contact ([#1555](https://github.com/fluencelabs/nox/issues/1555))
* **vault:** do not create vault on every particle ([#1553](https://github.com/fluencelabs/nox/issues/1553))
* **builtins:** add worker.list, move spell.list to worker scope [fixes NET-401 NET-435] ([#1537](https://github.com/fluencelabs/nox/issues/1537))
* **logs:** reduce logs ([#1534](https://github.com/fluencelabs/nox/issues/1534))
* **marine,avm:** avm-server 0.31.0, fluence-app-service 0.25.0 ([#1506](https://github.com/fluencelabs/nox/issues/1506))
* **deps:** update fluence-app-service minor version ([#1497](https://github.com/fluencelabs/nox/issues/1497))
* implement per-worker aliasing [NET-352] ([#1449](https://github.com/fluencelabs/nox/issues/1449))

### Features

* add restriction for installing modules with forbidden mounted binaries [NET-428] ([#1535](https://github.com/fluencelabs/nox/issues/1535)) ([481dbd4](https://github.com/fluencelabs/nox/commit/481dbd46c9eda18d22ec590514c71f9bfbb257d3))
* add service metrics for spells [fixes NET-441] ([#1565](https://github.com/fluencelabs/nox/issues/1565)) ([947dfa8](https://github.com/fluencelabs/nox/commit/947dfa8bfb75b438e79014c8585a4963c377c20b))
* add service type to distinguish services and spells ([#1567](https://github.com/fluencelabs/nox/issues/1567)) ([d80f89b](https://github.com/fluencelabs/nox/commit/d80f89bc8617a07b7cb3bb4103f1a015b924946e))
* add worker.create and worker.get_peer_id ([#1475](https://github.com/fluencelabs/nox/issues/1475)) ([ddc2f90](https://github.com/fluencelabs/nox/commit/ddc2f901cc2578386bae765e8a2029339d0fa801))
* **async runtime:** move async-std to tokio ([#1469](https://github.com/fluencelabs/nox/issues/1469)) ([08615a2](https://github.com/fluencelabs/nox/commit/08615a25711e7584d42ca2e97449e7812be5e332))
...
* **builtins:** add worker.list, move spell.list to worker scope [fixes NET-401 NET-435] ([#1537](https://github.com/fluencelabs/nox/issues/1537)) ([3884374](https://github.com/fluencelabs/nox/commit/38843745fd028cecde275f3170053f62fcce06dc))
* **builtins:** impl srv.info, dist.get_blueprint ([#1468](https://github.com/fluencelabs/nox/issues/1468)) ([8d21afa](https://github.com/fluencelabs/nox/commit/8d21afa7d6e22b81f557c011adc3b4b3eb6a6055))
* **builtins:** json.obj_pairs, json.puts_pairs to build JSON objects from array of pairs ([#1434](https://github.com/fluencelabs/nox/issues/1434)) ([3539f67](https://github.com/fluencelabs/nox/commit/3539f677308b833b2a9897d50a660b5ce038ad98))
...
* collect metrics for spell particles separately [fixes NET-439] ([#1550](https://github.com/fluencelabs/nox/issues/1550)) ([5711171](https://github.com/fluencelabs/nox/commit/57111712bc88882f5d4510fa9cebe6868f87725b))
* **config:** Introduce tracing config, change allowed_binaries list format ([#1608](https://github.com/fluencelabs/nox/issues/1608)) ([6f7c684](https://github.com/fluencelabs/nox/commit/6f7c68462dd69eb1f8b60a5b18f29fbd43884cd3))
* **config:** Layered configuration [fixes NET-424] ([#1551](https://github.com/fluencelabs/nox/issues/1551)) ([8e20c10](https://github.com/fluencelabs/nox/commit/8e20c10705a7ff817d6a0f54909ef582415c7775))
* **connection-pool:** Add libp2p connection limits ([#1437](https://github.com/fluencelabs/nox/issues/1437)) ([090ac84](https://github.com/fluencelabs/nox/commit/090ac84627c3ab915e9932887659155aa9bab669))
...
* **deps:** update fluence-app-service minor version ([#1497](https://github.com/fluencelabs/nox/issues/1497)) ([8c82741](https://github.com/fluencelabs/nox/commit/8c82741468083d38daaf73fd3a59be1f90fc2d2d))
* **dist:** make blueprint an IPLD, use CID as module ids [fixes NET-412 NET-432] ([#1595](https://github.com/fluencelabs/nox/issues/1595)) ([720a2b3](https://github.com/fluencelabs/nox/commit/720a2b353bd9ae7766329c5b02e3f2a34b37b903))
* extend peer identify with spell service version and allowed mounted binaries list [fixes NET-429 NET-381] ([#1540](https://github.com/fluencelabs/nox/issues/1540)) ([30eff87](https://github.com/fluencelabs/nox/commit/30eff87e1f9e20b01d7ffebb481dd820085775a7))
...
* implement per-worker aliasing [NET-352] ([#1449](https://github.com/fluencelabs/nox/issues/1449)) ([097d47d](https://github.com/fluencelabs/nox/commit/097d47dda079587281f312a8066e8f86652b9da5))
* **kademlia:** Forbid to use Provider API ([#1466](https://github.com/fluencelabs/nox/issues/1466)) ([2eb068f](https://github.com/fluencelabs/nox/commit/2eb068fcefa27b7e9b477229cd58761bec75e2d4))
* **libp2p:** Optional async std libp2p & debug profile ([#1454](https://github.com/fluencelabs/nox/issues/1454)) ([1aab9f7](https://github.com/fluencelabs/nox/commit/1aab9f71bb7811a122d73d2588fe4e16d8eecc7b))
* **log:** change 'particle received' log to info ([0047edf](https://github.com/fluencelabs/nox/commit/0047edfa60a06345aebbb5c5ed53de793963b08b))
* **log:** change 'particle received' log to info [NET-472] ([#1616](https://github.com/fluencelabs/nox/issues/1616)) ([0047edf](https://github.com/fluencelabs/nox/commit/0047edfa60a06345aebbb5c5ed53de793963b08b))
* **logging:** add structured fields in logging + new log format ([#1590](https://github.com/fluencelabs/nox/issues/1590)) ([0c06f1b](https://github.com/fluencelabs/nox/commit/0c06f1bd1e56b86b490a489b0b45e7dcb336f1d5))
* **logging:** structured logging and tracing ([#1582](https://github.com/fluencelabs/nox/issues/1582)) ([7e97e45](https://github.com/fluencelabs/nox/commit/7e97e4551236514c4bcb6a27cc3216bb817a2ab8))
* **logs:** print only first address of a Contact ([#1555](https://github.com/fluencelabs/nox/issues/1555)) ([32a46b2](https://github.com/fluencelabs/nox/commit/32a46b225a7ad8245c17908271cfc52739e6b989))
* **logs:** reduce logs ([#1534](https://github.com/fluencelabs/nox/issues/1534)) ([dc69146](https://github.com/fluencelabs/nox/commit/dc69146d6d096c2453450efad7e08d768ba78439))
...
* **marine,avm:** avm-server 0.31.0, fluence-app-service 0.25.0 ([#1506](https://github.com/fluencelabs/nox/issues/1506)) ([23820e9](https://github.com/fluencelabs/nox/commit/23820e93e8c5a5749f976f63520544fa88c621a2))
* **metrics:** add additional spell metrics [fixes NET-437] ([#1569](https://github.com/fluencelabs/nox/issues/1569)) ([ab851ac](https://github.com/fluencelabs/nox/commit/ab851accde1dfaca92b4011add1774caaa2bf9ea))
* **metrics:** add rust-peer version info in prometheus metrics [fixes NET-422] ([#1552](https://github.com/fluencelabs/nox/issues/1552)) ([460446b](https://github.com/fluencelabs/nox/commit/460446b01bab79117a4d61c6e40965d3e72a9945))
...
* **sig:** add insecure_sig ([#1458](https://github.com/fluencelabs/nox/issues/1458)) ([9727c3f](https://github.com/fluencelabs/nox/commit/9727c3f8522ea7caea5c570cfed768903ff7f4c9))
* **sig:** sig use worker keypair if called in worker scope [NET-371] ([#1455](https://github.com/fluencelabs/nox/issues/1455)) ([e45655b](https://github.com/fluencelabs/nox/commit/e45655bc565df7c7c967954699bcdbd7d52ef99b))
* **spells:** do json manipulations internally ([#1433](https://github.com/fluencelabs/nox/issues/1433)) ([ff36b61](https://github.com/fluencelabs/nox/commit/ff36b6144f129ed071edab610d980ca017a4c94c))
* **spells:** resolve spell_id by 'spell' and 'self' [NET-419] ([#1578](https://github.com/fluencelabs/nox/issues/1578)) ([65b2b26](https://github.com/fluencelabs/nox/commit/65b2b269c1355463c612d37f260d81c4422a793e))
* **spells:** support -relay- for spell scripts [NET-374] ([#1461](https://github.com/fluencelabs/nox/issues/1461)) ([b7c3427](https://github.com/fluencelabs/nox/commit/b7c342710a1e607d9af50f233c4d2ca5b0cda87b))
* **spells:** support empty trigger configs [NET-316] ([#1412](https://github.com/fluencelabs/nox/issues/1412)) ([46d8fd5](https://github.com/fluencelabs/nox/commit/46d8fd5763a1122406e11bc89a63edc7babeb081))
...
* support keypairs for spells [fixes NET-237, NET-239, NET-281 and NET-283] [#1382](https://github.com/fluencelabs/nox/issues/1382) ([63d0759](https://github.com/fluencelabs/nox/commit/63d07597d5fdc875adec1ade2b1010969422c87f))
...
* **vault:** do not create vault on every particle ([#1553](https://github.com/fluencelabs/nox/issues/1553)) ([aa0dd94](https://github.com/fluencelabs/nox/commit/aa0dd94b87d17d9238d8d23736184bd74f95c1a1))
* **worker:** add worker.remove [fixes NET-354 NET-376] ([#1499](https://github.com/fluencelabs/nox/issues/1499)) ([97f552f](https://github.com/fluencelabs/nox/commit/97f552f4fdbd94d943bd4896f5e8491ab791cd0e))
* **workers:** allow to deploy decider to root scope, fix aliasing ([#1488](https://github.com/fluencelabs/nox/issues/1488)) ([193a6e7](https://github.com/fluencelabs/nox/commit/193a6e7ff4af40ea1d90b42a6aff3629e86f52ac))


### Bug Fixes

* aqua-pool-size argument ([96fdf54](https://github.com/fluencelabs/nox/commit/96fdf54ba0b4c50ec8904d3f7ffbda15ab6d3772))
* **async:** move builtins call to blocking threadpool ([#1621](https://github.com/fluencelabs/nox/issues/1621)) ([7e18801](https://github.com/fluencelabs/nox/commit/7e188014e9bafbe5d6d9b15c6e62ea7b4b879b27))
* **avm-server:** update avm-server to one that user particle_id and peer_id in data_store ([#1494](https://github.com/fluencelabs/nox/issues/1494)) ([5ede2b0](https://github.com/fluencelabs/nox/commit/5ede2b031bc20fc7cb1220727cbc6c424610bafa))
...
* bug with repeated alias for service [NET-434] ([#1536](https://github.com/fluencelabs/nox/issues/1536)) ([ff455be](https://github.com/fluencelabs/nox/commit/ff455be54132a5b08977d91ef5bf67e6264d2c80))
* builtin redeploy and associated aliases bug ([#1486](https://github.com/fluencelabs/nox/issues/1486)) ([2c11e35](https://github.com/fluencelabs/nox/commit/2c11e3569c5bc35c3857335e1040b64abe3deedb))
* **ci:** fix tokio build for publish ([#1518](https://github.com/fluencelabs/nox/issues/1518)) ([8e7efac](https://github.com/fluencelabs/nox/commit/8e7efac096d2ec36e71056301d7e7b012a0015c3))
* **ci:** set permissions for release job ([f5842a8](https://github.com/fluencelabs/nox/commit/f5842a8c087092e69251e8d0f1b88cab79b0349f))
* collect separate metrics for root alised services and worker spells [fixes NET-431] ([#1539](https://github.com/fluencelabs/nox/issues/1539)) ([270cfd2](https://github.com/fluencelabs/nox/commit/270cfd2c3a1236fc2cbb19b68b0bb4714e871148))
* **config:** aqua-pool-size argument ([#1606](https://github.com/fluencelabs/nox/issues/1606)) ([96fdf54](https://github.com/fluencelabs/nox/commit/96fdf54ba0b4c50ec8904d3f7ffbda15ab6d3772))
* **config:** correctly parse env variables ([#1607](https://github.com/fluencelabs/nox/issues/1607)) ([2f77e04](https://github.com/fluencelabs/nox/commit/2f77e040cd7c9ba3839ace5b5d4a2a6be9bcf929))
* **connection-pool:** fixed logging ([#1463](https://github.com/fluencelabs/nox/issues/1463)) ([66e364e](https://github.com/fluencelabs/nox/commit/66e364ed022d033fccef8a1b4f9007992c566098))
* **connection-pool:** Keep only fluence peers in the connection pool ([#1440](https://github.com/fluencelabs/nox/issues/1440)) ([546bc6f](https://github.com/fluencelabs/nox/commit/546bc6f6a390790b461bb82450fc713b908f287c))
* **deps:** Bump spell to 0.5.0 ([#1483](https://github.com/fluencelabs/nox/issues/1483)) ([b03da8b](https://github.com/fluencelabs/nox/commit/b03da8b1e866d9ffa0887e4fc48b9ecc109799ee))
* **deps:** update libp2p to 0.50.0 [fixes [NET-232](https://linear.app/fluence/issue/NET-232)] [#1419](https://github.com/fluencelabs/nox/issues/1419) ([9c3eda8](https://github.com/fluencelabs/nox/commit/9c3eda83883ef7e21e5a4fb82c40b9f955aa2936))
...
* **deps:** update rust crate air-interpreter-wasm to v0.35.4 ([#1447](https://github.com/fluencelabs/nox/issues/1447)) ([b8de74d](https://github.com/fluencelabs/nox/commit/b8de74d693bfad4ced4e57c2e390e6552c6baac8))
* **deps:** update rust crate air-interpreter-wasm to v0.38.0 ([#1502](https://github.com/fluencelabs/nox/issues/1502)) ([12c74fb](https://github.com/fluencelabs/nox/commit/12c74fbe8cbedcc701838d153d4d8e85af80e979))
* **deps:** update rust crate avm-server to 0.28.1 ([#1420](https://github.com/fluencelabs/nox/issues/1420)) ([03887af](https://github.com/fluencelabs/nox/commit/03887af8f89ae5683faa2eed1cadb94df2d7ef22))
* **deps:** update rust crate fluence-app-service to 0.25.1 ([#1522](https://github.com/fluencelabs/nox/issues/1522)) ([446c342](https://github.com/fluencelabs/nox/commit/446c3422ec8c386f2f5d1eb0a62b69245e04863b))
* **deps:** update rust crate fluence-app-service to 0.25.3 ([#1541](https://github.com/fluencelabs/nox/issues/1541)) ([e5ecf30](https://github.com/fluencelabs/nox/commit/e5ecf30ad79bcfa70b214f3a07f94507153270f4))
* **deps:** update rust crate fluence-it-types to 0.4.0 ([#1467](https://github.com/fluencelabs/nox/issues/1467)) ([34cfc85](https://github.com/fluencelabs/nox/commit/34cfc853a3dd1ac57d6806491e1b074690be62f0))
* **deps:** update rust crate fluence-it-types to 0.4.1 ([#1523](https://github.com/fluencelabs/nox/issues/1523)) ([0480d06](https://github.com/fluencelabs/nox/commit/0480d06ea7a187d0511f4198a0ccb53edf4c5bfc))
* **deps:** update rust crate fluence-keypair to 0.10.1 ([#1609](https://github.com/fluencelabs/nox/issues/1609)) ([f5e0807](https://github.com/fluencelabs/nox/commit/f5e080721ab43d154776dc4548b1280c2b089fb5))
* **deps:** update rust crate fluence-spell-distro to 0.3.2 ([#1464](https://github.com/fluencelabs/nox/issues/1464)) ([d15c084](https://github.com/fluencelabs/nox/commit/d15c084ef92ad009be28634b26b86d14228d4cb3))
* **deps:** update rust crate fluence-spell-distro to v0.5.11 ([#1580](https://github.com/fluencelabs/nox/issues/1580)) ([cb4e69e](https://github.com/fluencelabs/nox/commit/cb4e69eebdb9617ed8f0083cd8c5c911039e99e1))
* **deps:** update rust crate fluence-spell-distro to v0.5.6 ([#1516](https://github.com/fluencelabs/nox/issues/1516)) ([97ceb92](https://github.com/fluencelabs/nox/commit/97ceb9202d0e665dc29f728bf4ce60e474e7f5c2))
* **deps:** update rust crate fluence-spell-distro to v0.5.7 ([#1532](https://github.com/fluencelabs/nox/issues/1532)) ([d027160](https://github.com/fluencelabs/nox/commit/d027160ad8341d4bac9b22e3dc18630488307141))
* **deps:** update rust crate fluence-spell-distro to v0.5.9 ([#1559](https://github.com/fluencelabs/nox/issues/1559)) ([47f5e20](https://github.com/fluencelabs/nox/commit/47f5e206a2c5212ed87806b21f857feb4cdafc4e))
* **deps:** update rust crate fluence-spell-dtos to 0.3.1 ([#1462](https://github.com/fluencelabs/nox/issues/1462)) ([72b426d](https://github.com/fluencelabs/nox/commit/72b426d68de22fd8ebfef8378d26736362b25cae))
* **deps:** update rust crate fluence-spell-dtos to 0.3.2 ([#1465](https://github.com/fluencelabs/nox/issues/1465)) ([4c13688](https://github.com/fluencelabs/nox/commit/4c136883d6733e9a68d249ac1044437a5e950bc4))
* **deps:** update rust crate fluence-spell-dtos to v0.5.11 ([#1581](https://github.com/fluencelabs/nox/issues/1581)) ([2bd135e](https://github.com/fluencelabs/nox/commit/2bd135e3c354d708f8c216c350a8e558d8243968))
* **deps:** update rust crate fluence-spell-dtos to v0.5.4 ([#1471](https://github.com/fluencelabs/nox/issues/1471)) ([b7c6b4d](https://github.com/fluencelabs/nox/commit/b7c6b4d206330d4c8d05932f533d43c1c078f1ca))
* **deps:** update rust crate fluence-spell-dtos to v0.5.6 ([#1517](https://github.com/fluencelabs/nox/issues/1517)) ([d93bece](https://github.com/fluencelabs/nox/commit/d93bece432cc6962b607ee99d83713f62ca572d1))
* **deps:** update rust crate fluence-spell-dtos to v0.5.7 ([#1533](https://github.com/fluencelabs/nox/issues/1533)) ([804cab8](https://github.com/fluencelabs/nox/commit/804cab8a0ea2ef513671f3a27ec9d543ad9ce5db))
* **deps:** update rust crate fluence-spell-dtos to v0.5.9 ([#1560](https://github.com/fluencelabs/nox/issues/1560)) ([f762b8b](https://github.com/fluencelabs/nox/commit/f762b8b2f9eaa4c008dd931e3df651436a4ff2cb))
* don't create libp2p metrics twice [fixes NET-348] ([#1545](https://github.com/fluencelabs/nox/issues/1545)) ([d023865](https://github.com/fluencelabs/nox/commit/d0238657e6c0e23df1ac14efea3b25e2efb270ac))
...
* **identify:** fix address logging ([#1619](https://github.com/fluencelabs/nox/issues/1619)) ([f90fdbf](https://github.com/fluencelabs/nox/commit/f90fdbf5babfbd0cad8a8811c9869e07e9ad072e))
* **keypairs:** load persisted keypair in a backward-compatible way ([#1481](https://github.com/fluencelabs/nox/issues/1481)) ([ab51b9c](https://github.com/fluencelabs/nox/commit/ab51b9cf32f0bf83776617d8c81113eb51285d8c))
* long arguments [fixes NET-442] ([#1579](https://github.com/fluencelabs/nox/issues/1579)) ([e4fd400](https://github.com/fluencelabs/nox/commit/e4fd400cede9fb2d5c8df14324588a55520d4195))
* **metrics:** Change _ to - in rust_peer_build_info ([#1558](https://github.com/fluencelabs/nox/issues/1558)) ([c741e24](https://github.com/fluencelabs/nox/commit/c741e24e826c74722167259b3fc578495c860586))
* **metrics:** collect metrics for custom services [fixes NET-438] ([#1549](https://github.com/fluencelabs/nox/issues/1549)) ([ed1ce37](https://github.com/fluencelabs/nox/commit/ed1ce37b393f8aa94f31f40ea5bff59194eadf7c))
* **metrics:** fix call metrics collection for aliased services ([#1487](https://github.com/fluencelabs/nox/issues/1487)) ([0e7b76e](https://github.com/fluencelabs/nox/commit/0e7b76e0f16847f7af554d784dd9ab316d9fc063))
* **metrics:** provide separate memory metrics for spells ([#1591](https://github.com/fluencelabs/nox/issues/1591)) ([9034e4a](https://github.com/fluencelabs/nox/commit/9034e4adfe065d5ae179e2831be05a0cda57eaaf))
* **metrics:** restrict metrics collection of aliased service on creation ([#1557](https://github.com/fluencelabs/nox/issues/1557)) ([040eb50](https://github.com/fluencelabs/nox/commit/040eb505fce48d48e38a075d9bf50558a542467d))
* **network:** fixed allow private addrs ([#1618](https://github.com/fluencelabs/nox/issues/1618)) ([7efb490](https://github.com/fluencelabs/nox/commit/7efb490af05693dcc4b46f9152b11359a4c384ef))
* remove worker_id check for service calls ([#1459](https://github.com/fluencelabs/nox/issues/1459)) ([ebfbf34](https://github.com/fluencelabs/nox/commit/ebfbf34faf9ad431e377a179250db4e18ae2ca8d))
* revert [#1459](https://github.com/fluencelabs/nox/issues/1459) and really fix worker id check for service calls ([#1460](https://github.com/fluencelabs/nox/issues/1460)) ([2978847](https://github.com/fluencelabs/nox/commit/2978847bbd5fa72e05dfc8c969b61c538ba184cb))
* **spells:** allow global aliases for builtin spells ([#1477](https://github.com/fluencelabs/nox/issues/1477)) ([e87b77c](https://github.com/fluencelabs/nox/commit/e87b77cade5235c6a50dc376ed886a051e7e0d6a))
* **spells:** Allow parallel execution of immut service functions [NET-331] ([#1430](https://github.com/fluencelabs/nox/issues/1430)) ([e9a05d6](https://github.com/fluencelabs/nox/commit/e9a05d6a8a402e0cfb7955a110ad79a15450ab1c))
* **spells:** correct interpretation of end_sec field [NET-346] ([#1431](https://github.com/fluencelabs/nox/issues/1431)) ([2b018de](https://github.com/fluencelabs/nox/commit/2b018dedeec4bcebf7d34ecfb47c6167e8c7f6ef))
* **spells:** do not run spells with passed (ended) Clock trigger ([#1452](https://github.com/fluencelabs/nox/issues/1452)) ([fe2184a](https://github.com/fluencelabs/nox/commit/fe2184af05bbe19123d58d0aba2a46750e891098))
* **spells:** start resubscribed spells scheduling after full node initialization [fixes NET-459] ([#1592](https://github.com/fluencelabs/nox/issues/1592)) ([1016f36](https://github.com/fluencelabs/nox/commit/1016f368cbd6e9804908842ee2562bff0e241e0e))
* **spells:** update trigger config by alias [NET-418] ([#1521](https://github.com/fluencelabs/nox/issues/1521)) ([0531848](https://github.com/fluencelabs/nox/commit/053184859054c3cc2aa684a5c67d74a7125d87f7))
* **spell:** update spell to 0.5.2 ([#1489](https://github.com/fluencelabs/nox/issues/1489)) ([d79a0da](https://github.com/fluencelabs/nox/commit/d79a0da72ff2c0cd4491f30fde477d95b97b0342))
* **startup:** Change link in "hello" message to Discord ([#1604](https://github.com/fluencelabs/nox/issues/1604)) ([c3c8b23](https://github.com/fluencelabs/nox/commit/c3c8b2377efe3dffcd250778e3d407bac2bede39))
...
* unnecessary vault creation ([#1566](https://github.com/fluencelabs/nox/issues/1566)) ([a9be656](https://github.com/fluencelabs/nox/commit/a9be6562a37ac40c5150dafd3b219a72486ef631))
