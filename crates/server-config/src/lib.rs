...
pub mod config_keys {
    pub use crate::resolved_config::{
        ALLOW_PRIVATE_IPS, BLUEPRINT_DIR, BOOTSTRAP_FREQ, BOOTSTRAP_NODE, CERTIFICATE_DIR,
        CONFIG_FILE, EXTERNAL_ADDR, EXTERNAL_MULTIADDRS, LOCAL, MANAGEMENT_PEER_ID,
        PROMETHEUS_PORT, ROOT_KEY_PAIR_FORMAT, ROOT_KEY_PAIR_GENERATE, ROOT_KEY_PAIR_PATH,
