...
pub mod config_keys {
    pub use crate::fluence_config::{
        BLUEPRINT_DIR, BOOTSTRAP_NODE, CERTIFICATE_DIR, CONFIG_FILE, EXTERNAL_ADDR, MANAGEMENT_KEY,
        ROOT_KEY_PAIR, SERVICES_WORKDIR, SERVICE_ENVS, TCP_PORT, WEBSOCKET_PORT,
    };
}
