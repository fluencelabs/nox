...
pub fn get_status(web3: &Web3<Http>, contract_address: Address) -> Result<Status, Error> {
    // TODO get more data

    let apps = get_apps(web3, contract_address)?;

    let nodes = get_nodes(web3, contract_address)?;
