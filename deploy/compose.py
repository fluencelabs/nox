...
CONFIG = {
    'services': {
        'fluence': {
            ...
            'volumes': ['fluence-1:/.fluence'],
            'container_name': '{container_name}',
            'image': 'fluencelabs/fluence:$TAG',
...
def gen_compose_file(scale, out, is_bootstrap, bootstraps, host, management_key, keypair):
    ...
    for i in range(0, scale):
        ...
        config[container_name] = copy.deepcopy(service)
        ...
        container_config['ports'] = container_config['ports'].format(
            tcp_port=tcp_port,
            ws_port=ws_port
        )
